if (document.currentScript.override < window.ontando_core_base_override) {
    ...
    (function(f, g) {
        ...
        var ontando_variables = {
            ...
            spawn : "connectDirect",
            sendActionPacket : "connectDirect",
            newDocument : "connectDirect",
        ...
        /*new*/ //FF issue: scripts are loaded not in original window... So all goes wrong in here
